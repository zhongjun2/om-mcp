...
| 2026-03-01 00:00:00 UTC | `1772534400000` |
| 2026-04-01 00:00:00 UTC | `1774310400000` |

> **易错点**：`1735689600000` 对应 **2025 年**，不是 2026 年。查询 2026 年数据的 `start` 应为 `1767225600000`。
...
get_stats_contribute(
    ...
    end=1774310400000      # 2026-04-01（覆盖至 3 月末）
)
```
